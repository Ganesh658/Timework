		...
		<div class="col-sm-9 col-md-9 col-xs-8">
			<div class="media applyed">
				...
				<div class="media-body">
					<h4 class="media-heading"><?php echo "Total Liked ".@sizeOf($results)." Jobs"; ?>
					</h4>
				</div>
			</div>
		</div>
						...
						<div class="postinfo">
							...
							<div class="col-sm-4 col-md-4  col-xs-6">
								<div class="like-symbol">
									<a href="<?php echo base_url(); ?>index.php/home/deleteLikedJob/1/<?php echo @$results[$r]->id; ?>" class="deleteConfirm">

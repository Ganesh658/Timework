...
.chosen-container-single .chosen-default,.chosen-container-multi .chosen-choices li.search-field input[type="text"]{color: #000 !important;}
</style>
...
<div class="just1 mbmrtp3">
	...
	<div class="col-sm-8 col-md-8 col-xs-12 mt-2">
		<div class="dash-basic">
			<form method="POST" action="<?php echo base_url("index.php/jobseeker/savePostJobs");?>" id="lang_info" class="form-horizontal updatePassword" name="" autocomplete='off'>
				<div class="">
					<?php
					...
					<div class="row">
						<div class="">
							<h4>Post Need Job<a href="<?php echo base_url(); ?>jobseeker/myJobs" class='backlist'><i class="fa fa-arrow-left" aria-hidden="true"></i> Back To My Posts</a>
							</h4>
						</div>
					</div>
					<div class="row hamsterchosen">
						...
						<div class="form-group">
						    <label class="control-label col-sm-3" for="email">Skills I Have<span class="mandatory">*</span>:</label>
						    <div class="col-sm-8">
			    		...
			    		if(@sizeOf($categories) > 0)
			    		{
				    		...
				    		?>
								<div class="form-group">
								    ...
								    <div class="col-sm-8">
								    	<select name="<?php echo @$clmName; ?>" class="form-control website-input " required>
								    		<?php 
						...
						<div class="form-group">
						    ...
						    <div class="col-sm-8">
						    	<select id="preferred_shift" name="preferred_shift" class="form-control website-input" required>
						    		<option value="1">Any Shift</option>
						    		<option value="2">Morning Shift</option>
						    		<option value="3">Afternoon Shift</option>
						    		<option value="4">Evening Shift</option>

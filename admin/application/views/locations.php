	...
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-sm-8">
			...
			<ol class="breadcrumb">
				...
				<li class="active">
					<strong>Locations - <span style="color: #1ab394;font-size: 15px;"><?php echo @$catInfo[0]->state_name;?> - <?php echo @$jsonObj->cityInfo[0]->city_name;?></span></strong>
				</li>
			</ol>
		</div>
		<div class="col-sm-4 pull-right">
			<h2>
				<a href="<?php echo base_url()?>index.php/home/createlocations/<?php echo @$jsonObj->cityId;?>/<?php echo @$stateId;?>" class="btn btn-w-m btn-primary pull-right">Add Location</a>
			</h2>
		</div>
	</div>
	<div class="row">
							...
							<table class="table table-striped table-bordered table-hover" id="editable">
								...
								?>
									<tr class="gradeX">
										...
										<td class="center">
											<?php echo @$categories[$i]->location_name;?>
										</td>	
										<td class="center">
										<?php
										...
										?>
											...
											<a style="color:red;font-weight: bold;" href="<?php echo base_url();?>index.php/home/locationsStatusChange/0/<?php echo @$categories[$i]->id?>/<?php echo @$jsonObj->cityId;?>/<?php echo @$stateId;?>">Make It Disable</a>
										<?php
										}
										...
										?>
											...
											<a style="color:green;font-weight: bold;" href="<?php echo base_url();?>index.php/home/locationsStatusChange/1/<?php echo @$categories[$i]->id?>/<?php echo @$jsonObj->cityId;?>/<?php echo @$stateId;?>">Make It Enable</a>
										<?php
										}
										?>
										</td>
										<td class="center">
											<a href="<?php echo base_url()?>index.php/home/editlocations/<?php echo @$categories[$i]->id;?>/<?php echo @$jsonObj->cityId;?>/<?php echo @$stateId;?>"><i class="fa fa-edit"></i></a> &nbsp; | &nbsp;
											<a href="<?php echo base_url()?>index.php/home/deletelocations/<?php echo @$categories[$i]->id;?>/<?php echo @$jsonObj->cityId;?>/<?php echo @$stateId;?>"><i class="fa fa-trash"></i></a>
										</td>
									</tr>
								<?php
									}

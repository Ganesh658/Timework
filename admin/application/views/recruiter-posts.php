					...
					<div class="ibox">                        
						...
						<div class="row">
							<div class="col-sm-12">
								<ul class="spekul">
									<li>
										<a <?php if(@$jsonObj->page_type == 0){echo 'style="background-color:#fff;color:#000;"';}?> href="<?php echo base_url();?>index.php/home/recruiterposts/0">Pending Posts</a>
									</li>
									<li>
										<a <?php if(@$jsonObj->page_type == 1){echo 'style="background-color:#fff;color:#000;"';}?> href="<?php echo base_url();?>index.php/home/recruiterposts/1">Approved Posts</a>
									</li>
								</ul>
							</div>
						</div>
							<table class="table table-striped table-bordered table-hover " id="editable" >
								<thead>
									<tr>
										...
										<th class="center">No Of Openings</th>									
								...
								?>
									<tr class="gradeX">
										...
										<td class="center"><?php echo @$results[$i]->no_of_openings?></td>
										<td class="center">
											<a href="<?php echo base_url();?>index.php/home/viewRecruiterPosts/<?php echo @$jsonObj->page_type; ?>/<?php echo @$results[$i]->id?>/1" class='btn btn-success'>
												View
											</a>
										</td>
										...
										<td class="center">
											...
											{
											?>
												<a style="color: #fff;font-weight: bold;" href="<?php echo base_url();?>index.php/home/approveposts/<?php echo @$results[$i]->id?>" class='btn btn-primary'>Approve Post</a>
											<?php 
											}
											else
											{

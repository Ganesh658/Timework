<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-sm-8">
		...
		<ol class="breadcrumb">
			...
			<li>
				<a href="<?php echo base_url()?>index.php/home/subcategories/<?php echo @$catId;?>">Sub Categories</a>
			</li>
			<li class="active">
				...
				<div class="col-lg-8">
					<div class="ibox">							
						<div class="ibox-content">
							<form method="POST" action="<?php echo base_url();?>index.php/home/savesubcategories/<?php echo @$catId;?>" class="form-horizontal" enctype="multipart/form-data">	
								<?php 
								...
								?>						
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" name="aFrom" id="aFrom" class="form-control" placeholder="Ex:0" required />
										</div>
									</div>
									<div class="hr-line-dashed"></div>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" name="aTo" id="aTo" class="form-control" placeholder="Ex:100000" required />
										</div>
									</div>
									<div class="hr-line-dashed"></div>
								<?php 
								...
								<!--<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="file" name="mainImage" id="mainImage" class="form-control" onChange="bannerImage()" required />
...
$("#category_name").blur(function(){
	...
	if(enterVal !='')
	{
		$.ajax({
			type:"POST",
			url:"<?php echo base_url();?>index.php/home/chkSubCategory",
			data:"&enterVal="+enterVal+"&catId="+catId,
			async:false,
			success:function(response)
			{
				if(response == 1)
				{
					...
					$('#category_name').attr("placeholder","Sub Category already exists");
	...
	{
		$('#category_name').css("border","1px solid #ccc");
		$('#category_name').attr("placeholder","Enter Sub Category Name");
	}
});
</script>
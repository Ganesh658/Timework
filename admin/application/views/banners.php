...
<link href="<?php echo base_url()?>externals/css/plugins/dataTables/dataTables.tableTools.min.css" rel="stylesheet">
	<div class="row wrapper border-bottom white-bg page-heading">
		...
		<div class="col-sm-4 pull-right">
			<h2>
				<a href="<?php echo base_url()?>index.php/home/createbanners" class="btn btn-w-m btn-primary pull-right">Add Banner</a>
			</h2>
		</div>
	</div>
	<div class="row">
							...
							<table class="table table-striped table-bordered table-hover " id="editable" >
								...
								?>
									<tr class="gradeX">
										...
										<?php
										if(@$banners[$i]->page_type == 1)
										{
											$pageName="Home";
										}
										elseif(@$banners[$i]->page_type == 2)
										{
											$pageName="About Us";
										}
										elseif(@$banners[$i]->page_type == 3)
										{
											$pageName="Contact";
										}
										elseif(@$banners[$i]->page_type == 4)
										{
											$pageName="Faqs For Candidates";
										}
										elseif(@$banners[$i]->page_type == 5)
										{
											$pageName="Faqs  For Recruiters";
										}
										elseif(@$banners[$i]->page_type == 6)
										{
											$pageName="Registration";
										}
										elseif(@$banners[$i]->page_type == 7)
										{
											$pageName="Login";
										}
										echo @$pageName;
										?>
										<td class="center"><?php echo @$pageName;?> Page</td>
										<td class="center"><?php echo @$banners[$i]->main_title?></td>
										<td class="center"><?php echo @$banners[$i]->sub_title?></td>
										<td class="center"><img style="width:200px;" src="<?php echo base_url();?>uploads/banners/<?php echo @$banners[$i]->banner_img?>"></td>
										<td class="center">
											<a href="<?php echo base_url()?>index.php/home/editbanners/<?php echo @$banners[$i]->id;?>"><i class="fa fa-edit"></i></a> &nbsp; | &nbsp;
											<a href="<?php echo base_url()?>index.php/home/deletebanners/<?php echo @$banners[$i]->id;?>" class='deleteItem'><i class="fa fa-trash"></i></a>
										</td>
									</tr>
								<?php
									}

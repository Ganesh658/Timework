				...
				<div class="col-lg-8">
					<div class="ibox">							
						<div class="ibox-content">
							<form method="POST" action="<?php echo base_url();?>index.php/home/savecategories" class="form-horizontal" enctype="multipart/form-data">	
...
$("#category_name").blur(function(){
	...
	if(enterVal !='')
	{
		$.ajax({
			type:"POST",
			url:"<?php echo base_url();?>index.php/home/chkCategory",
			data:"&enterVal="+enterVal,
			async:false,

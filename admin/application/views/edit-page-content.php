				...
				<div class="col-lg-10">
					<div class="ibox">
						...
						<div class="ibox-content">
							...
							<form method="POST" action="<?php echo base_url()?>index.php/home/updatepagecontent" class="form-horizontal" enctype="multipart/form-data">
							
								<div class="form-group">
									<label class="col-sm-2 control-label">Title</label>
									<div class="col-sm-8">
										<input type="text" name="cms_title" id="cms_title" class="form-control" value="<?php echo @$info[0]->cms_title;?>" />
									</div>
								</div>
								...
								?>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" name="sub_title" id="sub_title" class="form-control" required value="<?php echo @$info[0]->sub_title;?>">
										</div>
									</div>
									<div class="hr-line-dashed"></div>
								<?php 
								...
								?>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="file" accept="image/*" name="mainImage" id="mainImage" class="form-control" <?php 
									if(@$info[0]->cms_img == ''){echo "required";} ?>  <?php echo @$changeCond; ?>>
								...
								?>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<textarea name="long_desc" id="long_desc" class="form-control <?php echo @$txtcls; ?>" rows="6"><?php echo @$info[0]->long_desc;?></textarea>
										</div>
									</div>
									<div class="hr-line-dashed"></div>
								<?php 

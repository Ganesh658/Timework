				...
				<div class="col-lg-10">
					<div class="ibox">							
						<div class="ibox-content">
							<form method="POST" action="<?php echo base_url()?>index.php/home/savebenchcms" class="form-horizontal" enctype="multipart/form-data">
								<?php 
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" name="cms_title" id="cms_title" class="form-control" <?php echo @$requireds; ?>>
									</div>
								</div>

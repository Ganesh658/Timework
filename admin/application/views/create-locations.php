<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-sm-8">
		...
		<ol class="breadcrumb">
			...
			<li class="active">
				<strong>Add Locations - <span style="color: #1ab394;font-size: 15px;"><?php echo @$catInfo[0]->state_name;?> - <?php echo @$cityInfo[0]->city_name;?></span></strong>
			</li>
		</ol>
	</div>
				...
				<div class="col-lg-8">
					<div class="ibox">							
						<div class="ibox-content">
							<form method="POST" action="<?php echo base_url();?>index.php/home/savelocations" class="form-horizontal" enctype="multipart/form-data" autocomplete='off'>	

				...
				<div class="col-lg-7">
					<div class="ibox">						
						<div class="ibox-content">
							<form method="POST" action="<?php echo base_url()?>index.php/home/updatecities" class="form-horizontal" enctype="multipart/form-data" autocomplete='off'>
							
								<div class="form-group">
									<label class="col-sm-4 control-label">City Name</label>
									<div class="col-sm-8">
										<input type="text" name="location_name" id="location_name" class="form-control" placeholder="Enter Location Name" required value="<?php echo @$info[0]->city_name;?>" autocomplete='off'/>
									</div>
								</div>

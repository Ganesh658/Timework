...
<link href="<?php echo base_url()?>externals/css/plugins/dataTables/dataTables.tableTools.min.css" rel="stylesheet">
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-sm-8">
			<h2><?php echo @$pageName; ?> Content</h2>
			<ol class="breadcrumb">
				<li>
				...
				<li class="active">
					<strong><?php echo @$info[0]->cms_title; ?></strong>
				</li>
			</ol>
		</div>
		<div class="col-sm-4 pull-right">
			<h2>
				<a href="<?php echo base_url()?>index.php/home/createcontent/<?php echo @$rowId; ?>/<?php echo @$page_type; ?>" class="btn btn-w-m btn-primary pull-right">Add Content</a>
			</h2>
			<h2>
				<a href="<?php echo base_url()?>index.php/home/pagecontent/<?php echo @$page_type; ?>" class="btn btn-w-m btn-default pull-right" style="margin-right: 1em;">Back To List</a>
			</h2>
		</div>
	</div>
	<div class="row">
								...
								?>
									<tr class="gradeX">
										...
										<?php 
												...
												?>
										<td class="center">
											<a href="<?php echo base_url()?>index.php/home/editcontent/<?php echo @$rowId; ?>/<?php echo @$banners[$i]->id;?>/<?php echo @$page_type; ?>"><i class="fa fa-edit"></i></a> &nbsp; | &nbsp;
											<a href="<?php echo base_url()?>index.php/home/deletecontent/<?php echo @$rowId; ?>/<?php echo @$banners[$i]->id;?>/<?php echo @$page_type; ?>" class='deleteItem'><i class="fa fa-trash"></i></a>
										</td>
									</tr>
								<?php
									}

...
<link href="<?php echo base_url()?>externals/css/plugins/dataTables/dataTables.tableTools.min.css" rel="stylesheet">
	<div class="row wrapper border-bottom white-bg page-heading">
		...
		<div class="col-sm-4 pull-right">
			...
			?>
				<h2>
					<a href="<?php echo base_url()?>index.php/home/createseoinfo" class="btn btn-w-m btn-primary pull-right">Add Seo Info</a>
				</h2>
			<?php
			}
			?>
							...
							<table class="table table-striped table-bordered table-hover " id="editable" >
								...
								?>
									<tr class="gradeX">
										...
										<td class="center"><?php echo @$meta[$i]->seo_description?></td>
										<td class="center" style="width: 7%;">
											<a href="<?php echo base_url()?>index.php/home/editseoinfo/<?php echo @$meta[$i]->id;?>"><i class="fa fa-edit"></i></a> &nbsp; | &nbsp;
											<a href="<?php echo base_url()?>index.php/home/deleteseoinfo/<?php echo @$meta[$i]->id;?>" class='deleteItem'><i class="fa fa-trash"></i></a>
										</td>
									</tr>
								<?php
									}

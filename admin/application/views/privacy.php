...
<link href="<?php echo base_url()?>externals/css/plugins/dataTables/dataTables.tableTools.min.css" rel="stylesheet">
	<div class="row wrapper border-bottom white-bg page-heading">
		...
		<div class="col-sm-4 pull-right">
			<h2>
				<a href="<?php echo base_url()?>index.php/home/createprivacy" class="btn btn-w-m btn-primary pull-right">Add Content</a>
			</h2>
		</div>
	</div>
	<div class="row">
							...
							<table class="table table-striped table-bordered table-hover " id="editable" >
								<thead>
									<tr>
										...
										<th class="center" style="width:70%;">Description</th>
								...
								?>
									<tr class="gradeX">
										...
										<td class="center">
											<a href="<?php echo base_url()?>index.php/home/editprivacy/<?php echo @$banners[$i]->id;?>"><i class="fa fa-edit"></i></a> &nbsp; | &nbsp;
											<a href="<?php echo base_url()?>index.php/home/deleteprivacy/<?php echo @$banners[$i]->id;?>" class='deleteItem'><i class="fa fa-trash"></i></a>
										</td>
									</tr>
								<?php
									}
